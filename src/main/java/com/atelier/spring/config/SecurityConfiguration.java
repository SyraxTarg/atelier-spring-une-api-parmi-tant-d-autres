package com.atelier.spring.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/v1/user/**").hasRole("USER") // Accès user pour le crud
                        .requestMatchers("/api/v1/rebond/**").hasRole("REBOND") // Accès rebond pour le rebond
                        .requestMatchers("/api/v1/scrapper/**").hasRole("SCRAP") //Accès scrapper pour scrapper
                        // Accès public a certaines routes, notamment la page d'accueil, l'inscription et le login
                        .requestMatchers("/api/v1", "/api/v1/index", "/api/v1/test", "/api/v1/test/*", "/api/v1/register/*", "/api/v1/login").permitAll()
